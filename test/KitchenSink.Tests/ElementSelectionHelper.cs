...
namespace KitchenSink.Tests {
    public static class ByHelper {
        public static By PuppetClient {
            get {
                return By.CssSelector("html body puppet-client");
            }
        }
        ...
        public static By AnyTextarea {
            get {
                return By.XPath("(//textarea)[1]");
            }
        }

        public static By AnyTextareaFormControl {
            get {
                return By.XPath("(//textarea[@class='form-control'])[1]");
            }
        }

        public static By AnyControlLabel {
            get {
                return By.XPath("(//label[@class='control-label'])[1]");
            }
        }
        ...
        public static By AnyErrorLabel {
            get {
                return By.XPath("(//label[@class='error-label'])[1]");
            }
        }
